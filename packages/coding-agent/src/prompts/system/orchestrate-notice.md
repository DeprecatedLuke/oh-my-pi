...
3. **Dispatch phase.** Launch all parallel `task` subagents in one message, then end your turn and wait for their results — they arrive automatically as a follow-up turn once the batch settles — before moving on.
