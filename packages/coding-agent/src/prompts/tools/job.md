...
Background job results are delivered automatically as a follow-up turn when each job finishes. When no independent work remains, end the turn; results arrive automatically after completion.
